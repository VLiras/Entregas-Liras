    ...
    return(
        <div className="rounded-3 border mt-3 mb-3 p-3">
            <div style={{margin:'0 auto'}} className="cant row w-100 mt-2">
                <button style={{fontSize:'2vw'}} onClick={() => {add()}} type="button" className="btn btn-light col-3">+</button>
                <article className="stock col-6"><h3>{count}</h3></article>
                <button style={{fontSize:'2vw'}} onClick={() => {rest()}} type="button" className="btn btn-light col-3">-</button>
            </div>
